...
Feature: DMC
  ...
  #|FIELD NAME											|VALUE										|M|NOTES																																						|
   |Customer												|Mr Harlan Gilbert				|X|	Case Sensitive name of customer or $customerName,1 or 2	e.g.$customerName,1			|
   |Company Name										|Debts R Us								|X|																																									|
   |Street 1												|Debt House								|	|																																									|
   |Street 2												|Debt Street							|	|																																									|
   |City														|Debtsville								|	|																																									|
   |County													|Debtshire								|	|date in format dd/MM/YYYY or delta from today in format $date,+N,dd/MM/YYYY  		|
	 |Country													|England									|	|																																									|
   |Post Code												|DE5 0BT					  			|	|																																									|
   |Phone														|01958 458569			  			|	|																																									| 
   |Fax															|01958 458570			  			|	|																																									|
   |Third Party Type								|Debt Management Company	|X|																																									|
   #|Revoked													|true							  			|	|true/false																																				|
   |acts as insolvency practitioner |true											|	|true/false																																				|
   
    @editNewDebtManagementCompany
   Scenario:  Editing A Debt Management Company
   Given  I have account "A3EE80657316494ABC" open in Latitude
   Then I can "Edit" a Debt Management Company with the following details
  #|FIELD NAME											|VALUE										|M|NOTES																																						|
   |Customer												|Mr Harlan Gilbert				|X|	Case Sensitive name of customer or $customerName,1 or 2	e.g.$customerName,1			|
   |Company Name										|Debts R Us2							|X|																																									|
   |Revoked													|true							  			|	|true/false																																				|
